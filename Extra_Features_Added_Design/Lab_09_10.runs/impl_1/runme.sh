...
HD_PWD='D:/digi/Lab_09_10/Lab_09_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano_Processor_with_7SegOut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nano_Processor_with_7SegOut.tcl -notrace
