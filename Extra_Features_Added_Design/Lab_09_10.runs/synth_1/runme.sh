...
HD_PWD='D:/digi/Lab_09_10/Lab_09_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano_Processor_with_7SegOut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nano_Processor_with_7SegOut.tcl
