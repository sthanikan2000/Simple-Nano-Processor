...
HD_PWD='D:/digi/Lab_09_10_Sim/Lab_09_10/Lab_09_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Out_controll_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Out_controll_7seg.tcl
