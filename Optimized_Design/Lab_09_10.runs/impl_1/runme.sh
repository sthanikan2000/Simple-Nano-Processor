...
HD_PWD='D:/digi/Lab_09_10_Sim/Lab_09_10/Lab_09_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Out_controll_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Out_controll_7seg.tcl -notrace
